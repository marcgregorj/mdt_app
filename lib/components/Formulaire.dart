...
class Formulaire extends StatefulWidget {
  ...
  // Créez un constructeur avec la variable en paramètre
  Formulaire({required this.emailUser});
...
class _FormulaireState extends State<Formulaire> {
  ...
  Future<void> getNumberOfLines() async {
    // Accédez à la collection Firestore que vous souhaitez interroger
    CollectionReference collectionRef =
        FirebaseFirestore.instance.collection('statokap');

    // Effectuez la requête en utilisant la méthode 'where' pour filtrer par la propriété 'addedBy'
    QuerySnapshot querySnapshot = await collectionRef
        .where('addedBy', isEqualTo: 'gregor@ikaly.ht')
        .get();

    // Renvoie le nombre de documents retournés par la requête
    // return querySnapshot.size;

    //print(querySnapshot.size);

    setState(() {
      nbLines = querySnapshot.size;
    });
  }
  ...
  void resetForm() {
    ...
    quest4 = 'Une fois';
    quest5 = 'Hôtel/Motel';
    quest6 = 'Vacances/Loisirs';
    quest8 = 'Jacmel';
    quest9 = 'La Citadelle (PNH)';
    quest10 = 'Amis / Famille';
    quest12_A = 'Excellent';
    quest12_B = 'Excellent';
    quest12_C = 'Excellent';
    quest12_D = 'Excellent';
...
//Reset Input
    ...
    InputCtrlQuest7.text = "";
    InputCtrlQuest8.text = "";
    InputCtrlQuest9.text = "";

    InputCtrlQuest10_A.text = "";
    InputCtrlQuest10_B.text = "";
    InputCtrlQuest10_C.text = "";
    InputCtrlQuest10_D.text = "";
    InputCtrlQuest10_E.text = "";
    InputCtrlQuest10_F.text = "";
    InputCtrlQuest10_G.text = "";
    InputCtrlQuest10_H.text = "";
    InputCtrlQuest10_I.text = "";
    InputCtrlQuest10_J.text = "";

    InputCtrlQuest13_A.text = "";
    InputCtrlQuest13_B.text = "";

    InputCtrlQuest15.text = "";
    InputCtrlQuest16.text = "";

    InputCtrlQuest17.text = "";
    InputCtrlQuest18.text = "";
    InputCtrlQuest19.text = "";
  }
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Align(
                  ...
                  child: new Text(
                      '${widget.emailUser} added ${nbLines} Entries',
                                  ...
                                  children: [
                                    Expanded(
                                      child: DropdownButtonFormField(
                                        ...
                                        items:
                                            DataForm.choix2.map((String item) {
                                          return DropdownMenuItem(
                                            value: item,
                                            child: Text(item),
                                          );
                                    ...
                                    Expanded(
                                      child: DropdownButtonFormField(
                                        icon: const Icon(
                                            Icons.keyboard_arrow_down),
                                        items:
                                            DataForm.choix3.map((String item) {
                                          return DropdownMenuItem(
                                            value: item,
                                            child: Text(item),
                                          );
                            ...
                            children: [
                              ...
                              Expanded(
                                child: DropdownButtonFormField(
                                  ...
                                  decoration: InputDecoration(
                                    label: Text(
                                        "Personnel de service dans les hotels"),
                                    hintText: quest12_K,
                                    border: OutlineInputBorder(),
                                  ),
                                ),
